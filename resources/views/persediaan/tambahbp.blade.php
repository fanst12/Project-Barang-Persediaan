...
<html lang="en">
  ...
  <body>
    <br>
    <h1 class="text-center mb-3 mt-5">Tambah Barang Persediaan</h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
              ...
              <div class="card">
                <div class="card-body">
                  <form action="/insertbp" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                      ...
                      <input type="text" class="form-control" id="namabarang" name="nama_barang" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-2">
