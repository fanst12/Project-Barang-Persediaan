                        ...
                        <table class="table table-sm mt-2">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td> {{$value->Kfs->fungsi}}</td>
                                <td> {{$value->tanggal}}</td>
                                <td> {{$value->id_bp}}</td>
                                <td> {{$value->jumlah}}</td>
                                <td>
                                  <a href="tampilfp/{{$value->id}}"><i class="fas fa-edit"></i></a>&nbsp&nbsp&nbsp
                                  <a href="#"><i class="fas fa-trash-alt delete" datas-id="{{$value->id}}"
                                    datas-nomor="{{$value->no_surat}}"></i></a>
                                </td>
                              </tr>
                              @endforeach
                            </tbody> 
